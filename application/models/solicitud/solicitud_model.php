    ...
    function getSolicitudBySearch($busqueda) {
        ...
        */
        $sql = "SELECT TO_CHAR(TOC.CTOC_NROOC) ORDEN_NUMERO,
                       ...
                       END AS ALERTAFECHA,
                       SOL.COBRAIVA
                  FROM CONSTR.IN_TCTOC TOC, CONSTR.IN_TPROV PROV,
                       CONSTR.IN_VGESTION_CONTRACTUAL VGES,
                       (SELECT SOL.SEQ_NRO_SOLICITUD NRO_SOL,
                               SOL.NRO_ORDEN NRO_ORDEN,
                               SOL.COD_CATEGORIA CATEGORIA,
                               SOL.COD_USR_RESPONSABLE USR_RESP,
                ...
                SELECT TO_CHAR(TCON.CONT_NROCON) ORDEN_NUMERO,
                       PROV.PROV_PROV ID_PROVEEDOR,
                       TCON.CONT_VALOR + CONTR.VALOR_TOTAL_ADICPROR(TCON.CONT_CIAS,TCON.CONT_VIGCONT, 
                       ...
                       END AS ALERTAFECHA,
                       SOL.COBRAIVA
                  FROM CONTR.CO_TCONT TCON, CONSTR.IN_TPROV PROV,
                       (SELECT SOL.SEQ_NRO_SOLICITUD NRO_SOL,
                               SOL.NRO_ORDEN NRO_ORDEN,
                               SOL.COD_CATEGORIA CATEGORIA,
                               SOL.COD_USR_RESPONSABLE USR_RESP,
    ...
    function agregarSolicitud($data) {
        ...
        $params = array(
            ...
            array('name' => ':p_valor_bolsa',
                'value' => strval($data['valortotal']),
                'type' => SQLT_NUM, //SQLT_NUM, //SQLT_FLT,
                'length' => 32
            ),
