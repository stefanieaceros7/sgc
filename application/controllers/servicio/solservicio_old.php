...
class Solservicio extends CI_Controller {
    ...
    public function registrarSolServicio() {
        ...
        if ($isarchivo == '1') {
            ...
            $archivo["name"] = $this->session->userdata('usuario') . '_' . $this->input->post('seq_nro_sol') . '_' . time() . '.' . $kaboom[1];
            ...
            if (file_exists($url . $archivo["name"])) {
                ...
                if (!$archivo['error']) {
                    ...
                    if ((($kaboom[1] == 'jpg') || ($kaboom[1] == 'JPG')) ||
                            (($kaboom[1] == 'jpeg') || ($kaboom[1] == 'JPEG')) ||
                            (($kaboom[1] == 'png') || ($kaboom[1] == 'PNG')) ||
                            (($kaboom[1] == 'pdf') || ($kaboom[1] == 'PDF')) ||
                            (($kaboom[1] == 'doc') || ($kaboom[1] == 'DOC')) ||
                            (($kaboom[1] == 'docx') || ($kaboom[1] == 'DOCX')) ||
                            (($kaboom[1] == 'txt') || ($kaboom[1] == 'TXT')) ||
                            (($kaboom[1] == 'cvs') || ($kaboom[1] == 'CVS')) ||
                            (($kaboom[1] == 'xls') || ($kaboom[1] == 'XLS')) ||
                            (($kaboom[1] == 'zip') || ($kaboom[1] == 'ZIP')) ||
                            (($kaboom[1] == 'mp3') || ($kaboom[1] == 'MP3')) ||
                            (($kaboom[1] == 'wav') || ($kaboom[1] == 'WAV')) ||
                            (($kaboom[1] == 'wma') || ($kaboom[1] == 'WMA')) ||
                            (($kaboom[1] == 'cda') || ($kaboom[1] == 'CDA')) ||
                            (($kaboom[1] == 'mp4') || ($kaboom[1] == 'MP4')) ||
                            (($kaboom[1] == 'xlsx') || ($kaboom[1] == 'XLSX'))
                            ) {
